...
import evaluation_graph_baseline
from evaluation_graph_baseline import graph, ENTITY_CONFIG, SQL_TEMPLATE, PROMPTS
...
def initialize_entity_config(entity_type: str, entity_name: str):
    ...
    evaluation_graph_baseline.ENTITY_TYPE = entity_type
    evaluation_graph_baseline.ENTITY_NAME = entity_name
    
    cfg = ENTITY_CONFIG[entity_type]
    
    # Set SQL query for this entity type
    evaluation_graph_baseline.VECTOR_SQL = SQL_TEMPLATE.format(
    ...
    evaluation_graph_baseline.llm_prompt_template = PromptTemplate.from_template(
...
def main():
    ...
    output_dir = Path(r"C:\Uni\4th Year\GP\ECHO\data\chatbot\outputs\echo_agent_evaluation\agent_responses_baseline")
