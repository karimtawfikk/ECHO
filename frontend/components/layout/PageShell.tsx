                ...
                {menuOpen && !minimal && (
                  <>
                    ...
                    <motion.div
                      ...
                      className="fixed top-0 left-0 h-[100dvh] w-1/2 bg-[#0D0A07]/95 backdrop-blur-2xl border-r border-[#E6B23C]/20 shadow-[20px_0_50px_rgba(0,0,0,0.5)] z-[101] flex flex-col pt-16 px-4 sm:px-6"
                    >
                      <button
                        onClick={() => setMenuOpen(false)}
                          ...
                          return (
                            <div key={link.name} className="flex flex-col items-center">
                              <Link
                                href={link.href}
                                onClick={() => setMenuOpen(false)}
                                className={`text-sm font-bold tracking-[0.2em] uppercase transition-all flex items-center gap-4 py-2 ${isActive ? "text-[#E6B23C]" : "text-[#F5E6D0] hover:text-[#E6B23C]"
                                  }`}
                              >
                                {link.name}
                              </Link>
